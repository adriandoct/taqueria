...
export const MENU_JEFE: Taco[] = [
  // ── ALAMBRES ────────────────────────────────────────────────────────────────
  {
    ...
    precio: 130,
    imagen_url: '/menu/alambre-pastor.png',
    disponible: true,
    categoria: 'alambre',
  },
  {
    ...
    precio: 140,
    imagen_url: '/menu/alambre-bistec.png',
    disponible: true,
    categoria: 'alambre',
  },
  {
    ...
    precio: 120,
    imagen_url: '/menu/alambre-hawaiano.png',
    disponible: true,
    categoria: 'alambre',
  },
  {
    ...
    precio: 130,
    imagen_url: '/menu/alambre-especial.png',
    disponible: true,
    categoria: 'alambre',
  },
  {
  ...
  // ── TACOS (órdenes de 5) ─────────────────────────────────────────────────────
  {
    ...
    precio: 80,
    imagen_url: '/menu/tacos-orden.png',
    disponible: true,
    categoria: 'taco',
    unidad: 'orden de 5',
  },
  ...
  // ── SUIZO & SINCRONIZADA ──────────────────────────────────────────────────────
  {
    ...
    precio: 45,
    imagen_url: '/menu/sincronizada.png',
    disponible: true,
    categoria: 'suizo',
  },
  {
  ...
  // ── QUESADILLAS ───────────────────────────────────────────────────────────────
  {
    ...
    precio: 40,
    imagen_url: '/menu/quesadilla.png',
    disponible: true,
